...
<div class="row">
           ...
           <div class="panel-body" style="font-size:120%;">
            <div class="profile__avatar">
               <img src="artist_profile/'.$row["Prof_img"].'" class="img-thumbnail home_img" width="40px"  height="50px" alt="user img">
            </div>
      ...
      <div class="col-sm-3">
          <a href="adding/addpaintings.php" class="profile__contact-btn btn btn-lg btn-block btn-info" data-toggle="modal" data-target="#profile__contact-form">
          Add Painting
          </a>
          </div>
          ...
          <div class="col-sm-3">
              <a href="index.php" class="profile__contact-btn btn btn-lg btn-block btn-warning" data-toggle="modal" data-target="#profile__contact-form">
               Logout
              </a>
              </div>
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
             ...
             <table id="result"> <tr><th>Name</th><th> Types </th> <th> Likes </th><th> Price</th> <th> Sold </th></tr>';
              ...
              {
               echo   ' <tr>
                        <td>  <img src="images/'.$row2["Name"].'" class="img-thumbnail home_img" width="100px" alt="image"></td>
                         <td>'.$row2["Type"].'</td>
                        <td>' .$row2["Likes"].'</td>
                        <td>'.'Rs. '.$row2["Price"].'</td>
                        <td>'. $row2["Sold"].'</td>
